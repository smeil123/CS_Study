...
* deque는 인덱싱, 슬라이싱은 안되지만 연속적으로 나열된 데이터의 시작과 끝 부분에 데이터를 삽입, 삭제할 때느
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjcyMzAzODMsLTIwMzEzMDAwODgsMT
czMjQ1Njg4LDE3NzAzNDA1NzEsMTQzODc2NzM4NCwtMTg4NDkz
Nzk0Miw5OTI0NDY4NTJdfQ==
-->