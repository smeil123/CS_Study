...
* 귀납적 증명
	...
	** 귀납**
	...
* 시간복잡도 = O((V+E)logV)
	* VlogV : 모든 정점을 돌아야하는데 ->V, 이때 가장 거리가 짧은 정점을 찾아야한다(우선순위 큐,힙정렬) ->logV = VlogV
	* ElogV : 매 정점마다 모든 엣지를 업데이트 -> E, 이때 
### 벨만포드
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2MjM2NzI2OCwtMjA2MzE1Mjk4Niw4Nz
E2NTg1OTIsMTcwMzIzNTQ5OCwtMTQxNzU0Mzc4OCwtNzQ4NzMz
NDcyLDE0NjU1MjQyMzksLTg3ODA3ODU0NywtOTk2NDA3MzIyLD
YxMzIwNTQ2MSwtMTkzNjAwOTU1MCwtMTIxNDkyMDgwNSw1MzU0
NTAwNzQsMTk5OTkzNTkwMiw4OTkyODY3NTMsOTQzNzI4MjMsLT
M5MjI1ODczLDEyMTg3MTE4MTcsLTExNzM3MDUzMTgsMjQzMTQ5
NzIyXX0=
-->