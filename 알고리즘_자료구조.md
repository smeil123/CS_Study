...
### 구조체
* typedef 키워드 : C언어에서 자료형을 새롭게 이름을 붙일 때 쓰는 키워드이다. typedef를 이용하면 main함수에서 구조체를 선언할 때 매번 struct를 써줄 필요가 없다.
...
### 벨만포드
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDk1ODM1MSwxMjE4NzExODE3LC0xMTczNz
A1MzE4LDI0MzE0OTcyMiwyMDgwODE1NjE3XX0=
-->