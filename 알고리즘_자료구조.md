...
function Dijkstra(Graph, source): // source 시작
	...
	for each vertex v in Graph: //정점 순회
		if v != source
			dist[v] = INF
	while(!Q.empty){
		vertex next = Q.top(); Q.pop();
		for each vertex v in Graph:
			if(dist[v] > dist[next] + v
	}
```
### 벨만포드
<!--stackedit_data:
eyJoaXN0b3J5IjpbODcxNjU4NTkyLDE3MDMyMzU0OTgsLTE0MT
c1NDM3ODgsLTc0ODczMzQ3MiwxNDY1NTI0MjM5LC04NzgwNzg1
NDcsLTk5NjQwNzMyMiw2MTMyMDU0NjEsLTE5MzYwMDk1NTAsLT
EyMTQ5MjA4MDUsNTM1NDUwMDc0LDE5OTk5MzU5MDIsODk5Mjg2
NzUzLDk0MzcyODIzLC0zOTIyNTg3MywxMjE4NzExODE3LC0xMT
czNzA1MzE4LDI0MzE0OTcyMiwyMDgwODE1NjE3XX0=
-->