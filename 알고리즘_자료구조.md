...
void QuickSort(int *base, int n){
	...
	left = 0; right = n;
	while(1){
		for(left++; (left<n) && (base[pivot] < base[
	}
}
```
### 힙정렬
...
### 벨만포드
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg3ODA3ODU0NywtOTk2NDA3MzIyLDYxMz
IwNTQ2MSwtMTkzNjAwOTU1MCwtMTIxNDkyMDgwNSw1MzU0NTAw
NzQsMTk5OTkzNTkwMiw4OTkyODY3NTMsOTQzNzI4MjMsLTM5Mj
